            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                ...
                <option value="2">Out Of India</option>
                                           ...
                                           <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-2 control-label">Upload Report:</label>
                                                                     
                                       <div class="col-sm-4">          
                            <input type="file" class="form-control" id="productImage" placeholder="Test Name" accept=".pdf,.docx" name="productImage" class="file-loading" required style="width:auto;"/>
                                           </div>     
