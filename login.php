                        ...
                        <div class="login-content">
                            <div class="login-form">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm">
                                    ...
                                    <button type="submit" name="login" class="f-w-600 btn btn-primary btn-flat m-b-30 m-t-30">Ingresar</button>
...
<a href="search.php" class="text-right f-w-600"> Buscar Reportes</a>
</div>
                                </form>
                            </div>
                        </div>
