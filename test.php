       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> View Test</h3> </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add-test.php"><button class="btn btn-primary">Add Test</button></a>
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="edittest.php?id=<?php echo $row['product_id']?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-pencil"></i></button></a>
